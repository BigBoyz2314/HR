...
<head>
    ...
    <title>View Salary Sheets - Footprint HR</title>
    <!-- Tailwind CSS CDN -->
            ...
            <div class="max-w-2xl mx-auto space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200/80">
                    <div>
                        ...
                        <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">View Salary Sheets</h1>
                        <p class="text-sm text-slate-500 mt-1">Select month and year to view salary statements, slips, and payout details.</p>
                    </div>
                    <?php if ($_SESSION['role'] == '1'): ?>
                        <a href="includes/gen-salary.php" class="px-3.5 py-2.5 rounded-xl bg-teal-50 hover:bg-teal-100 text-teal-700 font-bold text-xs border border-teal-200 transition inline-flex items-center space-x-2">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200/80 space-y-6">
                    <form action="view-salary.php" method="get" class="space-y-5">
